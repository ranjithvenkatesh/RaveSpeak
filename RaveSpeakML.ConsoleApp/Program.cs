...
namespace RaveSpeakML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"D:\Projects\MaL\github\RaveSpeak\RaveSpeak\Data\wikipedia-detox-250-line-data.tsv";
        ...
        static void Main(string[] args)
        {
            ...
            ModelInput sampleData = new ModelInput { Sentiment = false, SentimentText = "I hate you"};
